...
<body class="w100">
	...
	<div id="app">
		<!--banner图-->
		<div class="banner"
			style="background-image: url('${pageContext.request.contextPath}/static/img/banner-${subject.id}.jpg')"></div>
		...
		<div class="classify">
			...
			<input type="hidden" id="subjectId" value="${course.sub.id}">
				<div class="section">
					...
					<ul>
						<c:forEach items="${course.videoSet }" var="video">
	...
	<script type="text/javascript">
		function getVideo(id){
			...
			location.href='${pageContext.request.contextPath}/front/video/index.do?id='+id+'&subjectId='+subjectId;
		}
	</script>
