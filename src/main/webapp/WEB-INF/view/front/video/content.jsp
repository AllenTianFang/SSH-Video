...
<div class="catalog">
	<div class="container">
		...
		<c:forEach items="${list}" var="video" >
			<div class="chapter">
				<p class="biaoti"><a href="${pageContext.request.contextPath}/front/video/index.do?id=${video.id}&subjectId=${subject.id}">${video.videoTitle}</a></p>
				...
				<div class="v-info">
					...
					<span class="duration"><img src="${pageContext.request.contextPath}/img/player.png" alt="">${video.videoLengthStr}</span>
				</div>
			</div>
		</c:forEach>
