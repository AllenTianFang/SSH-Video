...
<div>
    ...
    <div id="content">
		<%--  <%@include file="/WEB-INF/view/front/video/content.jsp" %>  --%>
    </div>
</div>
    ...
    <script>
        $(function () {
           ...
           $('#content').load('${pageContext.request.contextPath}/front/video/videoData.do?id='+id+'&subjectId='+sid);
           
           //播放量统计,不需要返回结果处理
           $.get('${pageContext.request.contextPath}/front/video/state.do?id='+id);
		});
    </script>
</body>
