        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/front/course/index.do?sub.id=1">
                        ...
                        <td>
                            <!--上线时修改id-->
                            <a href="${pageContext.request.contextPath}/front/course/index.do?sub.id=6">
                        ...
                        <td rowspan="2" class="one_three">
                            <a href="${pageContext.request.contextPath}/front/course/index.do?sub.id=2" class="opacity5">
                    ...
                    <tr>
                        <td>
                            <a href="${pageContext.request.contextPath}/front/course/index.do?sub.id=5" class="opacity5">
                        ...
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/front/course/index.do?sub.id=10">
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/front/course/index.do?sub.id=11">
