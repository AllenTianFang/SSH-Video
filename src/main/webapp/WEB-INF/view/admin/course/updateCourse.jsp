...
<body>
	...
	<div>
		...
		<form class="form-horizontal" action="${pageContext.request.contextPath}/admin/course/update.action" method="post">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<select name="sub.id" class="form-control">
						...
						<option value="${subject.id }" ${list.sub.id ==subject.id?"selected":"" }>${subject.subjectName }</option>
						</c:forEach>
					</select>
				</div>
			</div>
